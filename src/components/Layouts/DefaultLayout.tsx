          ...
          <SidebarProvider>
            ...
            <SidebarInset>
              <div className="main-content flex flex-col min-h-screen">
                <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''} flex sticky top-0 bg-background h-16 shrink-0 items-center gap-2 border-b px-4`}>
